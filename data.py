...
def limpieza_data(ruta):
    ...
    df.insert(0, "id", ruta[9] + df["show_id"].values)
...
df_amazon = limpieza_data("Datasets/amazon_prime_titles-score.csv")
df_disney = limpieza_data("Datasets/disney_plus_titles-score.csv")
df_hulu = limpieza_data("Datasets/hulu_titles-score (2).csv")
df_netflix = limpieza_data("Datasets/netflix_titles-score.csv")
